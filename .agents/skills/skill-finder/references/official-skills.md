...
Directory of 1184+ production-grade agent skills from 40+ engineering teams.
Organized by publisher and category.

Last updated: 2026-04-17
Refresh manually when new skills are released (see SKILL.md for the curl command).
...
| | | | |
|---|---|---|---|
| [Claude](#official-claude-skills) | [Composio](#skills-by-composio-team) | [Supabase](#skills-by-supabase-team) | [Google Gemini](#skills-by-google-gemini) |
...
| [Flutter](#skills-by-flutter) | [Community](#community-skills) | [Quality Standards](#skill-quality-standards) | |
